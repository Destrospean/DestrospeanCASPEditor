...
cp ../CASDesignerToolkit/bin/Release/* CASDesignerToolkit
rm CASDesignerToolkit/*.log
rar a -sfxwindows.sfx "CASDesignerToolkit-Self-Extractor.exe" CASDesignerToolkit/*
mv CASDesignerToolkit-Self-Extractor.exe ../CASDesignerToolkit/bin/Release
...
distrobox enter archlinux -- ./bundle_arch.sh
