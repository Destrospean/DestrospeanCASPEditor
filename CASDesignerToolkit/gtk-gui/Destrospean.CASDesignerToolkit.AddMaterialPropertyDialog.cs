...
namespace Destrospean.CASDesignerToolkit
{
	public partial class AddMaterialPropertyDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.CASDesignerToolkit.AddMaterialPropertyDialog
			this.WidthRequest = 320;
			this.HeightRequest = 128;
			this.Name = "Destrospean.CASDesignerToolkit.AddMaterialPropertyDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			// Internal child Destrospean.CASDesignerToolkit.AddMaterialPropertyDialog.VBox
			...
			w7.Position = 0;
			w7.Fill = false;
			// Internal child Destrospean.CASDesignerToolkit.AddMaterialPropertyDialog.ActionArea
