...
namespace Destrospean.CASDesignerToolkit
{
	public partial class ChoosePatternDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.CASDesignerToolkit.ChoosePatternDialog
			this.WidthRequest = 344;
			this.HeightRequest = 240;
			this.Name = "Destrospean.CASDesignerToolkit.ChoosePatternDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			// Internal child Destrospean.CASDesignerToolkit.ChoosePatternDialog.VBox
			...
			w7.Position = 0;
			// Internal child Destrospean.CASDesignerToolkit.ChoosePatternDialog.ActionArea
