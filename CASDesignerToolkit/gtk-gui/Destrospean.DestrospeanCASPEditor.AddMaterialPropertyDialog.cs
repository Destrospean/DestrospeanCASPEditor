...
{
	public partial class AddMaterialPropertyDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.DestrospeanCASPEditor.AddMaterialPropertyDialog
			this.WidthRequest = 320;
			this.HeightRequest = 128;
			this.Name = "Destrospean.DestrospeanCASPEditor.AddMaterialPropertyDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			// Internal child Destrospean.DestrospeanCASPEditor.AddMaterialPropertyDialog.VBox
			...
			w7.Position = 0;
			w7.Fill = false;
			// Internal child Destrospean.DestrospeanCASPEditor.AddMaterialPropertyDialog.ActionArea
