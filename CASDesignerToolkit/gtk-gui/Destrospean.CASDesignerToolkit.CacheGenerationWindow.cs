...
namespace Destrospean.CASDesignerToolkit
{
	public partial class CacheGenerationWindow
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.CASDesignerToolkit.CacheGenerationWindow
			this.WidthRequest = 320;
			this.HeightRequest = 128;
			this.Name = "Destrospean.CASDesignerToolkit.CacheGenerationWindow";
			...
			// Container child Destrospean.CASDesignerToolkit.CacheGenerationWindow.Gtk.Container+ContainerChild
