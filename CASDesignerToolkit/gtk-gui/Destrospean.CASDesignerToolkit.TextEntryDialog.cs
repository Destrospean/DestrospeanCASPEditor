...
namespace Destrospean.CASDesignerToolkit
{
	public partial class TextEntryDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.CASDesignerToolkit.TextEntryDialog
			this.WidthRequest = 320;
			this.HeightRequest = 128;
			this.Name = "Destrospean.CASDesignerToolkit.TextEntryDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			// Internal child Destrospean.CASDesignerToolkit.TextEntryDialog.VBox
			...
			w4.Position = 1;
			// Internal child Destrospean.CASDesignerToolkit.TextEntryDialog.ActionArea
