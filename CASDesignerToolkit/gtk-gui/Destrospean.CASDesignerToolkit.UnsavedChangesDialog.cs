...
namespace Destrospean.CASDesignerToolkit
{
	public partial class UnsavedChangesDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.CASDesignerToolkit.UnsavedChangesDialog
			this.WidthRequest = 320;
			this.HeightRequest = 120;
			this.Name = "Destrospean.CASDesignerToolkit.UnsavedChangesDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Unsaved Changes");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			// Internal child Destrospean.CASDesignerToolkit.UnsavedChangesDialog.VBox
			...
			w5.Position = 0;
			// Internal child Destrospean.CASDesignerToolkit.UnsavedChangesDialog.ActionArea
