...
{
	public partial class MessageFramelessWindow
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Destrospean.DestrospeanCASPEditor.MessageFramelessWindow
			this.WidthRequest = 320;
			this.HeightRequest = 128;
			this.Name = "Destrospean.DestrospeanCASPEditor.MessageFramelessWindow";
			this.Title = global::Mono.Unix.Catalog.GetString ("MessageFramelessWindow");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			this.Decorated = false;
			// Container child Destrospean.DestrospeanCASPEditor.MessageFramelessWindow.Gtk.Container+ContainerChild
